...
namespace Vocabulary.Views
{
    public partial class MainForm : Form, IMainView
    {
        ...
        public TextBox TextBoxEnglishWord { get { return textBoxEnglishWord; } }
        ...
        public event EventHandler ListViewWordsSelectedIndexChanged;

        private void ListViewWordsSelectedIndexChangedHandler(object sender, EventArgs e)
        {
            if (ListViewWordsSelectedIndexChanged != null)
                ListViewWordsSelectedIndexChanged(this, EventArgs.Empty);
        }
        ...
        public event EventHandler AddWordTo;

        private void AddWordToHandler(object sender, EventArgs e)
        {
            if (AddWordTo != null)
                AddWordTo(this, EventArgs.Empty);
        }

        public event EventHandler OpenTestWithKnownWordsForm;

        private void OpenTestWithKnownWordsFormHandler(object sender, EventArgs e)
        {
            if (OpenTestWithKnownWordsForm != null)
                OpenTestWithKnownWordsForm(this, EventArgs.Empty);
        }
    }
}